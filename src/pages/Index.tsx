  ...
  <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border">
    <div className="container mx-auto flex items-center justify-between h-16 px-4">
      <div className="flex items-center gap-2">
        ...
        <span className="font-display font-bold text-xl text-foreground">TechSpark</span>
      </div>
    ...
    <div className="container mx-auto px-4">
      <div className="max-w-3xl mx-auto text-center mb-16">
        ...
        <p className="text-lg text-muted-foreground">
          Millions of children lack access to basic technology, creating a gap in education and opportunity. TechSpark is here to change that.
        </p>
      </div>
    ...
    <div className="container mx-auto px-4">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-bold text-primary-foreground">TechSpark</span>
        </div>
        <p className="text-sm">© 2026 TechSpark Foundation. All rights reserved.</p>
      </div>
    </div>
  </footer>
);
